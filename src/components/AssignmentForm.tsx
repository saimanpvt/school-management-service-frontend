                ...
                <form onSubmit={handleSubmit} className={styles.form}>
                    <div className={styles.formRow}>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            {errors.classId && <span className={styles.errorText}>{errors.classId}</span>}
                        </div>
                    </div>
                    ...
                    <div className={styles.formRow}>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            />
                            {errors.dueTime && <span className={styles.errorText}>{errors.dueTime}</span>}
                        </div>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            />
                            {errors.maxMarks && <span className={styles.errorText}>{errors.maxMarks}</span>}
                        </div>
                    </div>
