...
export default function EduConnectLanding() {
  ...
  return (
    <div className={styles["landing-page"]}>
      ...
      {/* Features Section */}
      <section className={styles["section"]} data-section="features" ref={(el) => (sectionRefs.current["features"] = el)}>
        <div className={styles["section-container"]}>
          ...
          <div className={`${styles["features-grid"]} ${visibleSections.has("features") ? styles["fade-in"] : ""}`}>
      ...
      <section className={styles["section"]} style={{ background: 'linear-gradient(135deg, #ffffff 0%, #f8fafc 100%)' }} data-section="features-showcase" ref={(el) => (sectionRefs.current["features-showcase"] = el)}>
        <div className={styles["section-container"]}>
          <div className={styles["section-header"]}>
            <h2 className={styles["section-title"]}>
              See <span className={styles["title-highlight"]}>EduConnect</span> in Action
            </h2>
            <p className={styles["section-subtitle"]}>
              Explore our powerful features designed to transform your school management
            </p>
          </div>

          <div className={styles["features-showcase"]}>
            {/* Feature 1: Dashboard */}
            <div className={`${styles["feature-showcase-item"]} ${styles["alternate"]} ${visibleSections.has("features-showcase") ? styles["fade-in"] : ""}`}>
              <div className={styles["feature-showcase-content"]}>
                <div className={styles["feature-badge"]}>📊 Dashboard Analytics</div>
                <h3 className={styles["feature-showcase-title"]}>Real-Time Insights & Analytics</h3>
                <p className={styles["feature-showcase-desc"]}>
                  Get comprehensive insights into student performance, attendance trends, and academic progress with interactive dashboards. Make data-driven decisions with AI-powered analytics.
                </p>
              ...
              <div className={styles["feature-showcase-visual"]}>
                <div className={styles["dashboard-mockup"]}>
                  <div className={styles["mockup-header"]}>
                    ...
                    <div className={styles["mockup-title"]}>EduConnect Dashboard</div>
                  </div>
                  <div className={styles["mockup-content"]}>
                    <div className={styles["mockup-stats"]}>
                      <div className={styles["mockup-stat"]}>
                        ...
                        <div className={styles["mockup-stat-label"]}>Students</div>
                      </div>
                      <div className={styles["mockup-stat"]}>
                        <div className={styles["mockup-stat-icon"]}>✅</div>
                        <div className={styles["mockup-stat-value"]}>98%</div>
                        <div className={styles["mockup-stat-label"]}>Attendance</div>
                      </div>
                      <div className={styles["mockup-stat"]}>
                        <div className={styles["mockup-stat-icon"]}>📝</div>
                        <div className={styles["mockup-stat-value"]}>85</div>
                        <div className={styles["mockup-stat-label"]}>Avg Grade</div>
                      </div>
                    </div>
                    <div className={styles["mockup-chart"]}>
                      <div className={styles["chart-bar"]} style={{ height: '60%' }}></div>
                      <div className={styles["chart-bar"]} style={{ height: '80%' }}></div>
                      <div className={styles["chart-bar"]} style={{ height: '75%' }}></div>
                      <div className={styles["chart-bar"]} style={{ height: '90%' }}></div>
                      <div className={styles["chart-bar"]} style={{ height: '85%' }}></div>
                      <div className={styles["chart-bar"]} style={{ height: '95%' }}></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className={`${styles["feature-showcase-item"]} ${visibleSections.has("features-showcase") ? styles["fade-in"] : ""}`}>
              <div className={styles["feature-showcase-visual"]}>
                <div className={styles["attendance-mockup"]}>
                  <div className={styles["mockup-header"]}>
                    ...
                    <div className={styles["mockup-title"]}>Attendance Tracking</div>
                  </div>
                  <div className={styles["mockup-content"]}>
                    <div className={styles["attendance-list"]}>
                      {['John Doe', 'Sarah Smith', 'Mike Johnson', 'Emma Wilson'].map((name, i) => (
                        <div key={i} className={styles["attendance-item"]}>
                          <div className={styles["attendance-avatar"]}>{name.split(' ').map(n => n[0]).join('')}</div>
                          <div className={styles["attendance-info"]}>
                            <div className={styles["attendance-name"]}>{name}</div>
                            <div className={styles["attendance-status"]}>✅ Present</div>
                          </div>
                        </div>
                      ))}
                    </div>
                    <div className={styles["attendance-summary"]}>
                      <div className={styles["summary-item"]}>
                        <span className={styles["summary-label"]}>Today's Attendance</span>
              ...
              <div className={styles["feature-showcase-content"]}>
                <div className={styles["feature-badge"]}>📅 Smart Attendance</div>
                <h3 className={styles["feature-showcase-title"]}>Automated Attendance Tracking</h3>
                <p className={styles["feature-showcase-desc"]}>
                  Streamline attendance management with real-time tracking, automated notifications, and detailed reports. Save hours every week with our intelligent attendance system.
                </p>
                <ul className={styles["feature-list"]}>
            ...
            <div className={`${styles["feature-showcase-item"]} ${styles["alternate"]} ${visibleSections.has("features-showcase") ? styles["fade-in"] : ""}`}>
              <div className={styles["feature-showcase-content"]}>
                <div className={styles["feature-badge"]}>📝 Grade Management</div>
                <h3 className={styles["feature-showcase-title"]}>Complete Grade & Assessment System</h3>
                <p className={styles["feature-showcase-desc"]}>
                  Manage assignments, exams, and grades effortlessly. Provide detailed feedback, track progress, and generate comprehensive reports with our intuitive grading system.
                </p>
                <ul className={styles["feature-list"]}>
              ...
              <div className={styles["feature-showcase-visual"]}>
                <div className={styles["grades-mockup"]}>
                  <div className={styles["mockup-header"]}>
                    ...
                    <div className={styles["mockup-title"]}>Grades & Assessments</div>
                  </div>
                  <div className={styles["mockup-content"]}>
                    <div className={styles["grades-table"]}>
                      ...
                      {[
                        { course: 'Mathematics', grade: 'A', status: 'Excellent' },
                        ...
                        <div key={i} className={styles["table-row"]}>
                          <div>{item.course}</div>
                          <div className={styles["grade-badge"]}>{item.grade}</div>
                          <div className={styles["status-badge"]}>{item.status}</div>
                        </div>
                      ))}
                    </div>
                  </div>
            ...
            <div className={`${styles["feature-showcase-item"]} ${visibleSections.has("features-showcase") ? styles["fade-in"] : ""}`}>
                ...
                <div className={styles["messages-mockup"]}>
                  ...
                  <div className={styles["mockup-content"]}>
                    <div className={styles["messages-list"]}>
                      {[
                        { sender: 'Mrs. Johnson', message: 'Great progress on the project!', time: '10:30 AM' },
                        { sender: 'Mr. Smith', message: 'Parent meeting scheduled for...', time: '9:15 AM' },
                      ].map((msg, i) => (
                        <div key={i} className={styles["message-item"]}>
                          <div className={styles["message-avatar"]}>{msg.sender.split(' ').map(n => n[0]).join('')}</div>
                    ...
                    <div className={styles["message-input"]}>
                      <div className={styles["input-field"]}>Type a message...</div>
              ...
              <div className={styles["feature-showcase-content"]}>
                <div className={styles["feature-badge"]}>💬 Instant Communication</div>
                <h3 className={styles["feature-showcase-title"]}>Seamless Communication Hub</h3>
                <p className={styles["feature-showcase-desc"]}>
                  Connect teachers, students, and parents instantly. Send messages, announcements, and updates in real-time. Keep everyone informed and engaged.
                </p>
                <ul className={styles["feature-list"]}>
      ...
      <section className={styles["section"]} style={{ background: '#f8fafc' }} data-section="how-it-works" ref={(el) => (sectionRefs.current["how-it-works"] = el)}>
        <div className={styles["section-container"]}>
          <div className={styles["section-header"]}>
          ...
          <div className={`${styles["how-it-works-grid"]} ${visibleSections.has("how-it-works") ? styles["fade-in"] : ""}`}>
            {[
              { step: '1', icon: Smartphone, title: 'Sign Up', desc: 'Create your account in less than 2 minutes. No credit card required.' },
              { step: '2', icon: Building2, title: 'Setup School', desc: 'Add your school details, teachers, and students to get started.' },
              { step: '3', icon: Zap, title: 'Start Managing', desc: 'Begin managing classes, attendance, grades, and communication instantly.' },
              { step: '4', icon: Target, title: 'Scale & Grow', desc: 'Leverage AI insights and analytics to improve student outcomes.' },
            ].map((item, i) => (
              <div key={i} className={styles["step-card"]}>
                <div className={styles["step-number"]}>{item.step}</div>
                <div className={styles["step-icon"]}><item.icon /></div>
      ...
      <section className={styles["section"]} data-section="analytics" ref={(el) => (sectionRefs.current["analytics"] = el)}>
        <div className={styles["section-container"]}>
          <div className={styles["section-header"]}>
            <h2 className={styles["section-title"]}>Real-Time Analytics & Insights</h2>
            <p className={styles["section-subtitle"]}>
              Track growth and performance with powerful data visualizations
            </p>
          </div>

          <div className={`${styles["analytics-grid"]} ${visibleSections.has("analytics") ? styles["fade-in"] : ""}`}>
            <div className={styles["chart-card"]}>
              ...
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={growthData}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Line type="monotone" dataKey="schools" stroke="#6366f1" strokeWidth={3} name="Schools" />
                  <Line type="monotone" dataKey="students" stroke="#8b5cf6" strokeWidth={3} name="Students (000s)" />
                </LineChart>
              </ResponsiveContainer>
            </div>
      ...
      {/* Benefits Section */}
      <section className={styles["section"]} style={{ background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', color: 'white' }} data-section="benefits" ref={(el) => (sectionRefs.current["benefits"] = el)}>
        <div className={styles["section-container"]}>
          <div className={styles["section-header"]}>
            <h2 className={styles["section-title"]} style={{ color: 'white' }}>
              Why Schools Choose EduConnect
            </h2>
            <p className={styles["section-subtitle"]} style={{ color: 'rgba(255,255,255,0.9)' }}>
              Join thousands of institutions transforming education
            </p>
          </div>

          <div className={`${styles["benefits-grid"]} ${visibleSections.has("benefits") ? styles["fade-in"] : ""}`}>
            {[
              { icon: Clock, title: 'Save 10+ Hours/Week', desc: 'Automate administrative tasks and focus on teaching' },
              { icon: TrendingUp, title: '95% User Satisfaction', desc: 'Rated highly by teachers, students, and parents' },
              { icon: Lock, title: 'Enterprise Security', desc: 'Bank-grade encryption and GDPR compliance' },
              { icon: Globe, title: '24/7 Support', desc: 'Dedicated support team available anytime' },
              { icon: BarChart3, title: 'Data-Driven Insights', desc: 'AI-powered analytics to improve outcomes' },
              { icon: Award, title: 'Trusted by Leaders', desc: 'Used by top educational institutions globally' },
            ].map((benefit, i) => (
      ...
      <section className={styles["section"]} data-section="map" ref={(el) => (sectionRefs.current["map"] = el)}>
        <div className={styles["section-container"]}>
          <div className={styles["section-header"]}>
          ...
          <div className={`${styles["map-container"]} ${visibleSections.has("map") ? styles["fade-in"] : ""}`}>
            <div className={styles["map-visualization"]}>
              ...
              <div className={styles["map-markers"]}>
                {['🇺🇸', '🇬🇧', '🇨🇦', '🇦🇺', '🇩🇪', '🇫🇷', '🇯🇵', '🇸🇬', '🇮🇳', '🇧🇷'].map((flag, i) => (
                  <div key={i} className={styles["map-marker"]} style={{
