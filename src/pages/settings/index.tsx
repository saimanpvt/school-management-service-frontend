...
const Settings = () => {
    ...
    const getRoleClass = (role: string) => {
        switch (role.toLowerCase()) {
            case 'admin': return styles['role-admin'];
            case 'teacher': return styles['role-teacher'];
            case 'student': return styles['role-student'];
            case 'parent': return styles['role-parent'];
            default: return styles['role-student'];
        }
    };
        ...
        <div className={styles['settings-container']}>
            <div className={styles['settings-card']}>
                ...
                <div className={styles['settings-header']}>
                    ...
                    <p className={styles['settings-subtitle']}>Manage your profile information</p>
                </div>
                ...
                <div className={styles['profile-header']}>
                    ...
                    <span className={`${styles['role-badge']} ${getRoleClass(profile.role)}`}>
                        {profile.role}
                    </span>
                </div>
                ...
                <div className={styles['profile-content']}>
                    ...
                    <div className={styles['info-section']}>
                        ...
                        <div className={styles['info-item']}>
                            <div className={styles['info-icon']} style={{ fontSize: '12px', fontWeight: 'bold' }}>
                                ID
                            </div>
                            <div className={styles['info-content']}>
                    ...
                    <div className={styles['info-section']}>
                        ...
                        {profile.address && (profile.address.street || profile.address.city) && (
                            <div className={styles['info-item']}>
                                ...
                                <div className={styles['info-content']}>
                                    ...
                                    <div className={`${styles.value} ${styles['address-value']}`}>
                        ...
                        {!profile.dob && !profile.gender && !profile.bloodGroup && (!profile.address || (!profile.address.street && !profile.address.city)) && (
                            <div className={styles['info-item']}>
                                <div className={styles['info-content']}>
                                    <div className={styles.value} style={{ color: '#666', fontStyle: 'italic' }}>
