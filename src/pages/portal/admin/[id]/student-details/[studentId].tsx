                    ...
                    <div className={styles.detailsCard}>
                        ...
                        <div className={styles.cardContent}>
                            ...
                            <div className={styles.infoRow}>
                                ...
                                <strong>{getDisplayValue(student.timeWithUs ? `${student.timeWithUs} years` : null)}</strong>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className={styles.detailsCard}>
                        ...
                        <div className={styles.cardContent}>
                            {student.parent ? (
                                ...
                                <p className={styles.emptyMessage}>No parent information available</p>
                            )}
                        </div>
                    </div>
                    ...
                    <div className={styles.detailsCard}>
                        ...
                        <div className={styles.cardContent}>
                            {student.feeStatus ? (
                                    ...
                                    <div className={styles.infoRow}>
                                        ...
                                        <strong>
                                            <span
                                                ...
                                                style={{
                                                    backgroundColor: student.feeStatus.status === 'paid' ? '#dcfce7' :
                                                        student.feeStatus.status === 'pending' ? '#fef3c7' : '#fee2e2',
                                                    color: student.feeStatus.status === 'paid' ? '#166534' :
                                                        student.feeStatus.status === 'pending' ? '#92400e' : '#991b1b'
                                                }}
                                            >
                                ...
                                <p className={styles.emptyMessage}>No fee information available</p>
                            )}
                        </div>
                    </div>
                            ...
                            <div className={styles.statsGrid}>
                                <div className={styles.statItem}>
                                    <div
                                        ...
                                        style={{
                                            color: student.attendance?.percentage ? getPercentageColor(student.attendance.percentage) : '#6b7280'
                                        }}
                                    >
                                        {getDisplayValue(student.attendance?.percentage ? `${student.attendance.percentage}%` : null)}
                                    </div>
                                ...
                                <div className={styles.statItem}>
                                    <div className={styles.statValue}>
                                        {getDisplayValue(student.exams?.average ? `${student.exams.average}%` : null)}
                                    </div>
                                ...
                                <div className={styles.statItem}>
                                    <div
                                        className={styles.statValue}
                                        style={{
                                            color: student.progress?.overall ? getPercentageColor(student.progress.overall) : '#6b7280'
                                        }}
                                    >
                                        {getDisplayValue(student.progress?.overall ? `${student.progress.overall}%` : null)}
                                    </div>
                    ...
                    <div className={styles.detailsCard}>
                        ...
                        <div className={styles.cardContent}>
                            {student.results ? (
                                ...
                                <p className={styles.emptyMessage}>No recent results available</p>
                            )}
                        </div>
                    </div>
                </div>
