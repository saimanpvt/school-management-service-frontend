...
const UserManagement = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const requiredBaseFields = ['email', 'firstName', 'lastName', 'role', 'userID'];
            ...
            const optionalFields = ['phone', 'dob', 'gender', 'bloodGroup', 'address'];

            // Build final payload with required + optional fields
            const requiredFields = [...requiredBaseFields, ...(roleRequiredFields[formData.role] || [])];
    ...
    const getDisplayValue = (value: unknown, defaultValue: string = '-'): string | number => {
