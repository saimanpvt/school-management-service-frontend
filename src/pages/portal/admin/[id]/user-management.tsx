...
import { Users, Plus, Search, Edit, Trash2, UserCheck, GraduationCap, BookOpen, Heart, MoreVertical, Eye, Award, DollarSign, User2, CalendarDays, TrendingUp } from 'lucide-react';
...
const UserManagement = () => {
    ...
    const userTypeFilters = [
        ...
        { key: 'admin' as UserType, label: 'Admins', icon: UserCheck, color: '#7c3aed' }
    ];
        ...
        try {
            ...
            if (isEditMode && editingUserId) {
                ...
                if (response.success) {
                    ...
                    showSuccessAlert('User created successfully and credentials sent via email!');
            ...
            showErrorAlert(`Failed to ${isEditMode ? 'update' : 'create'} user. Please try again.`);
        }
    };
                ...
                <table className={styles.dataTable}>
                    ...
                    <tbody>
                        {filteredUsers.length > 0 ? (
                                    ...
                                    <tr key={user._id}>
                                        ...
                                        <td>
                                            ...
                                            >
                                                ...
                                                <small style={{ color: '#6b7280' }}>
                                                    Avg: {getDisplayValue(user.exams?.average ? `${user.exams.average}%` : null)}
                                                </small>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            >
                                                <div style={{
                                                    fontWeight: '600',
                                                    color: user.progress?.overall ? getPercentageColor(user.progress.overall) : '#6b7280'
                                                }}>
                                                    {getDisplayValue(user.progress?.overall ? `${user.progress.overall}%` : null)}
                                                </div>
                                                <small style={{ color: '#6b7280' }}>
                                        ...
                                        <td>
                                            ...
                                            >
                                                <div style={{
                                                    fontWeight: '600',
                                                    color: user.attendance?.percentage ? getPercentageColor(user.attendance.percentage) : '#6b7280'
                                                }}>
                                                    {getDisplayValue(user.attendance?.percentage ? `${user.attendance.percentage}%` : null)}
                                                </div>
                                                <small style={{ color: '#6b7280' }}>
                                            ...
                                            <td>
                                                ...
                                                >
                                                    ...
                                                    <div style={{ color: '#6b7280', fontSize: '0.75rem' }}>
                                                        {user.courses?.length ? user.courses.slice(0, 2).join(', ') : 'No courses'}
                                            ...
                                            <>
                                                <td>
                                                    <div
                                                        ...
                                                        style={{ fontSize: '0.875rem' }}
                                                    >
                                                        <div style={{ fontWeight: '600', color: getRoleColor(user.role) }}>
                                                ...
                                                <td>
                                                    ...
                                                    >
                                                        <span
                                                            ...
                                                            style={{
                                                                backgroundColor: user.feeStatus?.status === 'paid' ? '#dcfce7' :
                                                                    user.feeStatus?.status === 'pending' ? '#fef3c7' : '#fee2e2',
                                                                color: user.feeStatus?.status === 'paid' ? '#166534' :
                                                                    user.feeStatus?.status === 'pending' ? '#92400e' : '#991b1b',
                                                                padding: '2px 8px',
                                                                borderRadius: '12px',
                                                                fontSize: '0.75rem',
                                                                fontWeight: '600'
                                                        ...
                                                        >
                                                            {getDisplayValue(user.feeStatus?.status, 'Unknown')}
                                                        </span>
                                                    </div>
                                                </td>
                                            </>
                                                ...
                                                {openDropdown === user._id && (
                                                    <div className={styles.dropdownMenu}>
                                                        ...
                                                        <button
                                                            ...
                                                            onClick={() => {
                                                                handleDelete(user._id, `${user.firstName} ${user.lastName}`);
                                                                setOpenDropdown(null);
                                                            }}
                                                        >
                                                            <Trash2 size={14} />
                            ...
                            <tr>
                                <td colSpan={activeUserType === 'teacher' ? 7 : activeUserType === 'student' ? 8 : 6} className={styles.emptyState}>
                                    <Users size={48} />
