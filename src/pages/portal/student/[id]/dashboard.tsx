...
const StudentDashboard = () => {
    ...
    return (
        <div className={styles.dashboard_container}>
            <Sidebar name="Alex Johnson" role="student" />
                        ...
                        <table className={styles.data_table}>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Linear Algebra Quiz</td>
                                    <td>Oct 26, 2025</td>
                                    <td><span className={`${styles.status_badge} ${styles.warning}`}>Pending</span></td>
                                </tr>
                                <tr>
                                    <td>Physics</td>
                                    <td>Lab Report</td>
                                    <td>Oct 28, 2025</td>
                                    <td><span className={`${styles.status_badge} ${styles.danger}`}>Overdue</span></td>
                                </tr>
                                <tr>
                                    <td>Chemistry</td>
                                    <td>Molecular Structure</td>
                                    <td>Oct 25, 2025</td>
                                    <td><span className={`${styles.status_badge} ${styles.success}`}>Submitted</span></td>
                                </tr>
                            </tbody>
                        </table>
                    </section>
                        ...
                        <div className={styles.activity_list}>
                            <div className={styles.activity_item}>
                                ...
                                <div className={styles.activity_content}>
                                    <div className={styles.activity_title}>Submitted Math Assignment 3</div>
                            ...
                            <div className={styles.activity_item}>
                                <div className={styles.activity_icon}>📝</div>
                                <div className={styles.activity_content}>
                                    <div className={styles.activity_title}>New quiz available in Science</div>
                            ...
                            <div className={styles.activity_item}>
                                <div className={styles.activity_icon}>📊</div>
                                <div className={styles.activity_content}>
                                    <div className={styles.activity_title}>Physics test results updated</div>
                    ...
                    <section className={styles.calendar_section}>
                        ...
                        <div className={styles.calendar_grid}>
                            {Array.from({ length: 7 }, (_, i) => (
                                <div key={i} className={`${styles.calendar_day} ${i === 3 ? styles.active : ''}`}>
                                    {24 + i}
                                </div>
                            ))}
                        </div>
                    ...
                    <div className={styles.chart_container}>
                        <div className={styles.chart_legend}>
                            <div className={styles.legend_item}>
                                <span className={styles.legend_color} style={{ background: '#3b82f6' }}></span>
                                <span>Current Semester</span>
                            </div>
                            <div className={styles.legend_item}>
                                <span className={styles.legend_color} style={{ background: '#e2e8f0' }}></span>
